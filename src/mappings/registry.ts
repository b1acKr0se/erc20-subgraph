...
//   let address: string | null = rawData[0].isNull()
//     ? null
//     : rawData[0].toString();
//   let name: string | null = rawData[1].isNull() ? null : rawData[1].toString();
//   let symbol: string | null = rawData[2].isNull()
//     ? null
//     : rawData[2].toString();
//   let decimals: u32 = rawData[3].isNull()
//     ? DEFAULT_DECIMALS
//     : rawData[3].toBigInt().toI32();
//   let description: string | null = rawData[4].isNull()
//     ? null
//     : rawData[4].toString();
//   let imageUrl: string | null = rawData[5].isNull()
//     ? null
//     : rawData[5].toString();
